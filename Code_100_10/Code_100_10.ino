 ...
 int utilityPin   = A10 ; 
  ...
  void setup() {
        Serial.begin(9600);         
        pinMode(A8, INPUT);  pinMode(11, OUTPUT); digitalWrite(11, LOW);  
        pinMode(A9, INPUT);  pinMode(12, OUTPUT); digitalWrite(12, LOW); 
        pinMode(A10, INPUT); pinMode(13, OUTPUT); digitalWrite(13, LOW);
